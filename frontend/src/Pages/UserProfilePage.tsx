        ...
        return (
            <div className="flex min-h-screen items-center justify-center">
                <div className="text-center">
                    ...
                    <button
                        onClick={() => navigate(-1)}
                        className="rounded-xl bg-slate-100 dark:bg-white/10 px-4 py-2 text-slate-600 dark:text-white hover:bg-slate-200 dark:hover:bg-white/20"
                    >
                        Go Back
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen p-4 md:p-8">
            <div className="mx-auto max-w-lg">
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="mb-6 flex items-center gap-2 rounded-xl bg-slate-100 dark:bg-white/10 px-4 py-2 text-slate-600 dark:text-white transition hover:bg-slate-200 dark:hover:bg-white/20"
                >
                    <svg
                        className="h-5 w-5"
                        fill="none"
                ...
                <div className="glass-panel rounded-3xl p-8 text-center">
                    ...
                    {/* Bio */}
                    {user.bio && (
                        <div className="mb-6 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 px-4 py-3">
